<?php
    $idCharacter = $data[0]['id_character'];
    $name        = $data[0]['name'];
...
<html lang = "en">
    <head>
        ...
        <!-- PageData -->
        <title>Actualización de personaje</title>
    ...
    <body>
        <div class = "container">
            ...
            <h1 class = "mt-5 mb-5 text-center">Actualizar personaje</h1>
            <form method = "POST" action = "<?php echo base_url().'update' ?>" enctype = "multipart/form-data">
                <div class = "row">
                    <input type = "text" id = "idCharacter" name = "idCharacter" hidden = "" value = "<?php echo $idCharacter ?>">
                    ...
                    <div class = "mb-5 col-12">
                        ...
                        <textarea 
                            ...
                            class       = "form-control"
                            rows        = "5"
                            placeholder = "Es un multimillonario industrial, anterior Director General de Industrias Stark y miembro fundador de los Vengadores."
                            required
                    ...
                    <div class = "mb-3 col-12 w-100">
                        <div class = "row g-2">
                            <div class = "col-sm-12 col-md-6">
                                <a href = "<?php echo base_url(); ?>" class = "btn btn-danger w-100" type = "submit">Cancelar</a>
                            </div>
                            <div class = "col-sm-12 col-md-6">
